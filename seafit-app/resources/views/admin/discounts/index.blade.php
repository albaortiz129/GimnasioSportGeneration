{{-- Vista de admin para listar y gestionar codigos de descuento. --}}
@extends('layouts.app')
...
@section('contenido')
    <div class="max-w-6xl mx-auto px-4 py-8">
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            {{-- Boton para crear un nuevo cupon desde admin. --}}
            <a href="{{ route('admin.discounts.create') }}" class="bg-[#0A1931] text-white px-4 py-2 rounded">
                Nuevo codigo
            </a>
        </div>

        {{-- Tabla principal con todos los codigos creados. --}}
        <div class="bg-white border rounded-xl overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody>
                    @forelse($codes as $c)
                        {{-- Fila de cada codigo con sus acciones rapidas. --}}
                        <tr class="border-t">
                    ...
                    @empty
                        {{-- Estado vacio cuando aun no hay cupones. --}}
                        <tr>
