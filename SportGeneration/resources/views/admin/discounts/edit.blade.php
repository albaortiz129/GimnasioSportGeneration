...
@section('contenido')
    <div class="max-w-4xl mx-auto px-4 py-8">
        <h1 class="text-2xl font-black text-[#265e1f] mb-6">Editar código: {{ $discountCode->code }}</h1>
        ...
        <form action="{{ route('admin.discounts.update', $discountCode) }}" method="POST"
            ...
            <div class="pt-2 flex gap-3">
                ...
                <button class="bg-[#265e1f] text-white px-4 py-2 rounded font-bold">Guardar cambios</button>
