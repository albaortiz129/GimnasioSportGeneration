...
@section('contenido')
    <div class="max-w-7xl mx-auto py-8 px-4">
        ...
        <form action="{{ route('admin.classes.store') }}" method="POST"
            ...
            <button class="bg-[#265e1f] text-white rounded p-2 font-bold">Crear clase</button>
        ...
        <div class="flex gap-2 overflow-x-auto mb-6">
            <a href="{{ route('admin.classes.index') }}"
                class="px-4 py-2 rounded-full text-sm font-bold {{ empty($dia) ? 'bg-[#265e1f] text-white' : 'bg-gray-100 text-gray-600' }}">
                Todos
            </a>
            @foreach($diasSemana as $d)
                ...
                <a href="{{ route('admin.classes.index', ['dia' => $d]) }}"
                    class="px-4 py-2 rounded-full text-sm font-bold {{ ($dia ?? null) === $d ? 'bg-[#265e1f] text-white' : 'bg-gray-100 text-gray-600' }}">
                    {{ $diaVisible }}
                </a>
            @endforeach
        </div>
            ...
            @foreach($clases as $clase)
                ...
                <div class="bg-white border rounded-2xl p-4">
                    ...
                    <form action="{{ route('admin.classes.update', $clase) }}" method="POST"
                        ...
                        <button class="bg-[#265e1f] text-white rounded p-2 font-bold">Guardar clase</button>
                        ...
                        <div>
                            ...
                            <form action="{{ route('admin.classes.usuarios.store', $clase) }}" method="POST" class="space-y-2">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <button class="bg-[#265e1f] text-white px-4 rounded"
