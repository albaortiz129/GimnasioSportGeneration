            ...
            <div class="bg-white rounded-[2.5rem] p-10 md:p-16 shadow-sm border border-gray-100">
                ...
                <header class="text-center mb-12">
                    <h1 class="text-[#265E1F] text-5xl font-black mb-6 tracking-tight leading-tight">
                        Nuestra historia: La pasiÃ³n por el deporte.
                    </h1>
                </header>
                ...
                <div class="space-y-8">
                    <p class="text-gray-600 text-lg leading-relaxed text-center italic">
                        <strong>Sport Generation Sports</strong> naciÃ³ en MÃ¡laga con una visiÃ³n simple: hacer la vida fitness mucho
                        mÃ¡s sencilla.
                    </p>

                    <p class="text-gray-600 text-[17px] leading-relaxed">
                        No somos solo un gimnasio; somos un centro de bienestar integral diseÃ±ado para que nuestros socios
                        no solo alcancen sus metas fÃ­sicas, sino que encuentren un equilibrio mental.
                    </p>
                    ...
                    <section>
                        ...
                        <ul class="space-y-4">
                            <li class="flex items-start gap-3 text-gray-600 text-[17px]">
                                <span class="text-[#265E1F] mt-1">â€¢</span>
                                <span><strong>Excelencia:</strong> Equipamiento de Ãºltima generaciÃ³n y los mejores
                            ...
                            <li class="flex items-start gap-3 text-gray-600 text-[17px]">
                                ...
                                <span><strong>Comunidad:</strong> Creamos un ambiente motivador donde todos nos apoyamos
                                    mutuamente para poder mejorar cada dÃ­a.</span>
                            </li>
                            <li class="flex items-start gap-3 text-gray-600 text-[17px]">
                                <span class="text-[#265E1F] mt-1">â€¢</span>
                                <span><strong>Flexibilidad:</strong> Ofrecemos acceso ilimitado y gestiÃ³n 100% online para
                                    adaptarnos a tu ritmo de vida actual.</span>
                            </li>
                            <li class="flex items-start gap-3 text-gray-600 text-[17px]">
                                <span class="text-[#265E1F] mt-1">â€¢</span>
                                <span><strong>Bienestar Integral:</strong> Priorizamos tanto la fuerza fÃ­sica como la salud
                                    mental a travÃ©s de nuestras zonas wellness y relax.</span>
                            </li>
                        </ul>
                    </section>
                    ...
                    <section>
                        ...
                        <p class="text-gray-600 text-[17px] leading-relaxed">
                            Continuamos expandiendo nuestros servicios, introduciendo nuevas clases colectivas y tecnologÃ­a
                            de seguimiento deportivo. Nuestro objetivo es ser tu aliado definitivo en el camino hacia un
                            estilo de vida mÃ¡s saludable y activo.
                        </p>
                    </section>
