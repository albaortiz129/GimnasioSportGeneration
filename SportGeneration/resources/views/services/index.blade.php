        ...
        <main class="flex flex-1 flex-col items-center flex-grow">
            ...
            <div class="w-full text-center py-16 bg-[#F8F8F8] border-b border-gray-200">
                <h1 class="text-gray-900 text-4xl lg:text-5xl font-black leading-tight tracking-tighter">
                    Descubre lo mejor de Sport Generation
                </h1>
            ...
            <div class="layout-content-container flex flex-col w-full max-w-7xl flex-1 gap-16 px-4 py-16 lg:py-24">
                ...
                @if(session('success'))
                    <div
                        class="bg-[#c6ff7c] text-green-800 p-4 rounded-2xl border border-[#c6ff7c] font-bold text-center animate-bounce">
                        {{ session('success') }}
                    </div>
                @endif
                ...
                <section id="clases"
                    ...
                    <div class="flex flex-col gap-6 justify-center">
                        <div class="w-14 h-14 rounded-full flex items-center justify-center bg-[#265e1f]/10">
                            <span class="material-symbols-outlined text-4xl text-[#265e1f]">groups</span>
                        </div>
                        ...
                        <div class="bg-gray-50 p-6 rounded-2xl border border-gray-100 space-y-4">
                            ...
                            <div class="flex items-center gap-3 text-sm font-bold text-gray-500">
                                <span class="w-4 h-4 rounded-full bg-[#c6ff7c] shadow-sm"></span> Disponible
                            </div>
                            <div class="flex items-center gap-3 text-sm font-bold text-gray-500">
                        ...
                        <button onclick="window.location.href='{{ route('agenda') }}'"
                            class="flex w-fit items-center justify-center rounded-2xl h-14 px-8 bg-[#265e1f] text-white text-lg font-bold hover:bg-[#265e1f] transition-all shadow-lg mt-4 uppercase tracking-tighter">
                            Ver agenda completa
                        </button>
                    </div>
                            ...
                            @foreach($diasSemana as $diaItem)
                                <a href="{{ route('servicios', ['dia' => $diaItem['value']]) }}#clases"
                                    class="flex-shrink-0 text-xs font-black px-6 py-2.5 rounded-full transition-all uppercase tracking-widest
                                                                                                                                                                                                                                                                                                                                                                    {{ $diaActivo == $diaItem['value'] ? 'bg-[#265e1f] text-white shadow-lg scale-105' : 'bg-gray-100 text-gray-400 hover:bg-gray-200' }}">
                                    {{ $diaItem['label'] }}
                                </a>
                            @endforeach
                        </div>
                            ...
                            <div
                                ...
                                @forelse($clases as $clase)
                                    ...
                                    <div class="absolute rounded-3xl p-5 border-l-[8px] shadow-sm transition-all group overflow-hidden
                                                                                                                                                                                                                {{ $yaReservado ? 'bg-[#e6f3ff] border-[#265e1f] ring-1 ring-inset ring-[#265e1f]/20' : ($estaCompleto ? 'bg-gray-100 border-gray-400' : 'bg-white border-[#c6ff7c] hover:shadow-xl hover:-translate-y-0.5 border shadow-sm') }}"
                ...
                <section id="entrenador"
                    ...
                    <div class="flex flex-col gap-6 justify-center text-left">
                        <div
                            class="w-16 h-16 rounded-3xl flex items-center justify-center bg-[#265e1f] text-white rotate-3">
                ...
                <section id="membresia"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 relative z-10">
                        <div
                            class="p-10 rounded-2xl bg-[#F8FAFC] border border-gray-100 hover:border-[#265e1f]/20 hover:bg-white transition-all duration-300 group shadow-sm hover:shadow-md">
                            <span
