    ...
    <div class="flex flex-col md:flex-row min-h-screen bg-[#EAF7DB] font-sans">
        ...
        <main class="flex-1 p-6 md:p-10 lg:p-12 max-w-[1000px]">
            <header class="mb-8">
                ...
                @if(session('success'))
                    <div
                        class="bg-[#ADFE01] text-green-800 p-4 rounded-xl mb-4 border border-[#ADFE01] font-medium flex items-center gap-2">
            ...
            <section class="bg-white rounded-2xl p-6 md:p-8 mb-8 shadow-sm border border-gray-100">
                ...
                @foreach($metodosPago as $metodo)
                    ...
                    <div
                        class="border {{ $esPrincipal ? 'border-[#ADFE01] bg-[#ADFE01]' : 'border-gray-200 bg-[#EAF7DB]' }} rounded-xl p-5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
                ...
                @foreach($metodosManuales as $manual)
                    ...
                    <div
                        class="border {{ $esPrincipalManual ? 'border-[#ADFE01] bg-[#ADFE01]' : 'border-gray-200 bg-[#EAF7DB]' }} rounded-xl p-5 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
                        <div class="flex items-center gap-4">
