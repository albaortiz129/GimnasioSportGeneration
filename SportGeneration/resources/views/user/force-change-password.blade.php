...
@section('contenido')
    <div class="max-w-lg mx-auto my-12 bg-white p-8 rounded-2xl shadow border">
        ...
        <h1 class="text-2xl font-bold mb-2 text-[#265e1f]">Cambia tu contraseña</h1>
        ...
        <form action="{{ route('password.force.update') }}" method="POST" class="space-y-4">
            ...
            <button type="submit" class="w-full bg-[#265e1f] text-white py-3 rounded-xl font-bold">Guardar</button>
        </form>
    </div>
@endsection